...
void hardcodDatosArray(Entidad list[], int len)
{
    int i;

    int idEmpleado[QTY_ENTIDAD_TEST] = {1,2,3,4,5};
    char nombreEmpleado[QTY_ENTIDAD_TEST][LONG_NAME_EMPLOYE]= {"Nicolas","Nicolas","Pedro","Juan","Marcelo"};
    char apellidoEmpleado[QTY_ENTIDAD_TEST][LONG_NAME_EMPLOYE]= {"A_Letticugna","E_Dominguez","C_Gonzalez","Z_Dominguez","E_Dominguez"};
